...
// upstream is a variable edit, not a redeploy.
const DEFAULT_MODEL = 'gemini-2.5-flash-preview-tts';
const TIMEOUT_MS = Number(process.env.GEMINI_TTS_TIMEOUT_MS) || 30_000;
 ...
 * inlineData and finishReason: STOP). Concatenating in arrival order and
 * wrapping once at the end reproduces exactly what the non-streaming call
